//Sat Jul 27 2024 03:16:26 GMT+0000 (Coordinated Universal Time)
...
const _0x2bad9c = 2.08,
  ...
  _0x281cdf = "b15d289bce11425490409fcf07fd6b32",
  _0x3d9810 = "10000002",
  ...
  async woread_addReadTime(_0x1f2346 = {}) {
    try {
      ...
      if (_0x4851e5 == "0000") {
        ...
        if (_0x1f9eec?.["data"]?.["readtime"] >= 3600000) {
          this.read_stop = true;
        }
      } else {
  ...
  async woread_m_addReadTime(_0x513b98 = {}) {
    try {
      ...
      if (_0x22bdf8 == "0000") {
        ...
        if (_0xc66009?.["data"]?.["readtime"] >= 3600000) {
          this.read_stop = true;
        }
      } else {
...
function _0x4a9430(_0x3dc8ae) {
  return new class {
    ...
    time(_0xc0075d, _0x39d0d0 = null) {
      ...
      for (let _0x13db8b in _0x3e8b62) if (new RegExp("(" + _0x13db8b + ")").test(_0xc0075d)) {
        _0xc0075d = _0xc0075d.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x3e8b62[_0x13db8b] : ("00" + _0x3e8b62[_0x13db8b]).substr(("" + _0x3e8b62[_0x13db8b]).length));
      }
      return _0xc0075d;
    }
    async showmsg() {
