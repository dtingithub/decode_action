...
class HHYD:
    ...
    def getKey(self):
        uk = ""
        ukRes = None
        u = f"http://{self.domnainHost}/yunonline/v1/{self.readJumpPath}"
        # print("提示 getKey：", u)
        ...
        # <script src="https://image.hzysmyy.cn/yunsaoma/js/article.js?v4.0"></script>
        readJsVersion = extract_middle_text(r.text, "js/article.js?", '"')
        checkJsCodeChanged = (
            check_file_md5(
                extract_middle_text(r.text, '<script src="', '"></scrip'),
                "871da29cdcbfcd051c4dbeece76dafab",
            )
            == False
        )
        if (readJsVersion != "v10.0") or checkJsCodeChanged:
            print(
    ...
    def read(self):
        ...
        while True:
            ...
            while res["errcode"] != 0:
                ...
                u = f"https://nsr.zsf2023e458.cloud/yunonline/v1/getwenzhang"
                r = safe_request(
                    "GET",
                    u,
                    headers=info[1],
            ...
            if res.get("errcode") == 0:
                ...
                u1 = f"https://nsr.zsf2023e458.cloud/yunonline/v1/get_read_gold?uk={info[0]}&time={sleepTime}&timestamp={ts()}"
    ...
    def run(self):
        if self.init():
            ...
            if (currentHour < readTimeRange[0]) or (currentHour > readTimeRange[1]):
                print(
...
def getNewInviteUrl():
    ...
    if r.get("code") == 0:
        ...
        return f"http://u7ds.sy673.shop/yunonline/v1/auth/2639bb95daba1d99e5338a8c2e21e2f0?codeurl=u7ds.sy673.shop&codeuserid=2&time=1709021176".replace(
            "u7ds.sy673.shop", host or "u7ds.sy673.shop"
        )
    else:
        return "http://u7ds.sy673.shop/yunonline/v1/auth/2639bb95daba1d99e5338a8c2e21e2f0?codeurl=u7ds.sy673.shop&codeuserid=2&time=1709021176"
